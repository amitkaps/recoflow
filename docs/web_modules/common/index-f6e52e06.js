import { p as hasOwnProperty, $, ae as splitAccessPath, M as isNumber, L as isString, ai as writeConfig, H as toSet, r as logger, ah as Warn, o as isObject, d as isArray, a as array, Y as isBoolean$1, af as mergeConfig, b as isFunction, ad as parseSelector, i as identity, ab as parse } from './index-16a640fb.js';
            ...
            return makeImplicit([
                {
                    ...
                    data: isBoolean(sort) ? model.requestDataName(MAIN) : model.requestDataName(RAW),
...
function mergeDomains(domains) {
    ...
    const unionDomainSorts = unique(sorts.map(s => {
        if (isBoolean(s) || !('op' in s) || s.op in MULTIDOMAIN_SORT_OP_INDEX) {
            return s;
        }
...
export { __awaiter as _, createCommonjsModule as a, vegaLiteImport as b, compile as c, extractTransforms as e, normalize$1 as n, unwrapExports as u, version$1 as v };
